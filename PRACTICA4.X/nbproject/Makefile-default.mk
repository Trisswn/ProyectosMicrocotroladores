...
SOURCEFILES_QUOTED_IF_SPACED=WDTPRACTICE.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/WDTPRACTICE.o
POSSIBLE_DEPFILES=${OBJECTDIR}/WDTPRACTICE.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/WDTPRACTICE.o

# Source Files
SOURCEFILES=WDTPRACTICE.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PRACTICA4.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/WDTPRACTICE.o: WDTPRACTICE.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/WDTPRACTICE.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/WDTPRACTICE.o \
	WDTPRACTICE.asm \
...
${DISTDIR}/PRACTICA4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/PRACTICA4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
