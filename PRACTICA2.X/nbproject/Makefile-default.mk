...
SOURCEFILES_QUOTED_IF_SPACED=PROGRAMA2.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PRACTICA2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/PROGRAMA2.o: PROGRAMA2.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
...
${DISTDIR}/PRACTICA2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/PRACTICA2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
