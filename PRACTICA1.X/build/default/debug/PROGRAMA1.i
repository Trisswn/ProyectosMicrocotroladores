...
# 543 "/opt/microchip/mplabx/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/pic_as_chip_select.inc" 3
# 1 "/opt/microchip/mplabx/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f84a.inc" 1 3
# 47 "/opt/microchip/mplabx/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f84a.inc" 3
INDF equ 0000h
...
EECON2 equ 0089h
# 506 "/opt/microchip/mplabx/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/proc/pic16f84a.inc" 3
...
# 544 "/opt/microchip/mplabx/v6.25/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8/pic/include/pic_as_chip_select.inc" 2 3
...
INICIO:
 ...
 movlw 0b00000110
 movwf TRISA ; Configurar ((PORTA) and 07Fh), 1 y ((PORTA) and 07Fh), 2 como entradas
...
BUCLE:
 ...
 btfsc PORTA, 1 ; Revisa si ((PORTA) and 07Fh), 1 está en 0, si lo está, salta la siguiente instrucción
 goto APAGAR ; Si ((PORTA) and 07Fh), 1 es 1 entonces va a la rutina APAGAR

 btfsc PORTA, 2 ; Revisa si ((PORTA) and 07Fh), 2 está en 0, si lo está, salta la siguiente instrucción
 goto APAGAR ; Si ((PORTA) and 07Fh), 2 es 1 entonces va a la rutina APAGAR

ENCENDER:

 movlw 0b00000011
 movwf PORTB ; Encender LEDs en ((PORTB) and 07Fh), 0 y ((PORTB) and 07Fh), 1
 goto BUCLE
