...
LEER_EEPROM: ;
        ...
        bcf EECON1, 7 ; ((EECON1) and 07Fh), 7 = 0 (Memoria de datos)
        bsf EECON1, 0 ; ((EECON1) and 07Fh), 0 = 1 (Iniciar lectura)
...
ESCRIBIR_EEPROM: ; Basada en manual y datasheet
        ...
        bsf STATUS, 5 ; Cambiar al banco 3
        bcf EECON1, 7 ; ((EECON1) and 07Fh), 7 = 0 (Seleccionar datos)
        bsf EECON1, 2 ; ((EECON1) and 07Fh), 2 = 1 (Habilitar escritura)
        bcf INTCON, 7 ; Deshabilitar ((INTCON) and 07Fh), 7 por seguridad
        movlw 0x55
        movwf EECON2 ; Secuencia de desbloqueo 1
        movlw 0xAA
        movwf EECON2 ; Secuencia de desbloqueo 2
        bsf EECON1, 1 ; ((EECON1) and 07Fh), 1 = 1 (Iniciar escritura física)
        bsf INTCON, 7 ; Reabilitar interrupciones

ESPERAR_WR: ; Bucle de espera
        btfsc EECON1, 1 ; ¿Bit ((EECON1) and 07Fh), 1 sigue activo?
        goto ESPERAR_WR ; Esperar a que termine el hardware
        bcf EECON1, 2 ; ((EECON1) and 07Fh), 2 = 0 (Protección)
        bcf STATUS, 6
        bcf STATUS, 5 ; Regresar al Banco 0
        bcf PIR2, 4 ; Limpiar bandera ((PIR2) and 07Fh), 4 (bit 4)
        return
