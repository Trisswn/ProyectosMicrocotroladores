...
FINAL_IMAGE=${DISTDIR}/PRACTICA5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=CONTADOR_HZ.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/CONTADOR_HZ.o
POSSIBLE_DEPFILES=${OBJECTDIR}/CONTADOR_HZ.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/CONTADOR_HZ.o

# Source Files
SOURCEFILES=CONTADOR_HZ.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PRACTICA5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PRACTICA5.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/CONTADOR_HZ.o: CONTADOR_HZ.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/CONTADOR_HZ.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/CONTADOR_HZ.o \
	CONTADOR_HZ.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PRACTICA5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/PRACTICA5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
