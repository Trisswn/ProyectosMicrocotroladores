...
FINAL_IMAGE=${DISTDIR}/PRACTICA2U2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=SENSORES.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/SENSORES.o
POSSIBLE_DEPFILES=${OBJECTDIR}/SENSORES.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/SENSORES.o

# Source Files
SOURCEFILES=SENSORES.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PRACTICA2U2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PRACTICA2U2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/SENSORES.o: SENSORES.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/SENSORES.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/SENSORES.o \
	SENSORES.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PRACTICA2U2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/PRACTICA2U2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
